...
class Child_Care_Kindergarten_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function child_care_kindergarten_loadClassLoader($class)
    {
    ...
    public static function child_care_kindergarten_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
