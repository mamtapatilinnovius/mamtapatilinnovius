...
class Child_Care_Kindergarten_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function child_care_kindergarten_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function child_care_kindergarten_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function child_care_kindergarten_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function child_care_kindergarten_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->child_care_kindergarten_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function child_care_kindergarten_load( $class ) {
